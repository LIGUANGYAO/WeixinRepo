...
CREATE TABLE `accept_address` (
  ...
  `detail_address` varchar(50) DEFAULT NULL COMMENT 'detail address of address except province,city and area',
...
-- Records of admin
-- ----------------------------
INSERT INTO `admin` VALUES ('1', 'admin', 'admin', '1', 'c31b32364ce19ca8fcd150a417ecce58', '0', '2018-03-13 12:30:51', null, '1', '2018-03-26 03:56:32', null);
...
-- ----------------------------
INSERT INTO `alarm_admin` VALUES ('615', '0', '285', null, '2018-05-22 11:40:52', '0');
INSERT INTO `alarm_admin` VALUES ('616', '0', '0', null, '2018-05-22 11:44:50', '0');
INSERT INTO `alarm_admin` VALUES ('617', '0', '286', null, '2018-05-22 12:03:43', '0');
...
CREATE TABLE `alarm_user` (
  ...
  PRIMARY KEY (`no`)
) ENGINE=MyISAM AUTO_INCREMENT=1299 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of alarm_user
-- ----------------------------
INSERT INTO `alarm_user` VALUES ('1298', '286', '6', null, null, '2018-05-22 12:05:09', '0', '0', null);
...
CREATE TABLE `binding` (
  ...
  `amount` float DEFAULT '0' COMMENT 'amount of money the user have on this program',
  PRIMARY KEY (`no`),
...
CREATE TABLE `booking` (
  ...
  `reg_num` smallint(5) DEFAULT NULL COMMENT 'number of sign up by this user',
...
CREATE TABLE `boss` (
  ...
  `map_icon` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`no`),
...
CREATE TABLE `event` (
  ...
  `detail_address` varchar(40) DEFAULT NULL COMMENT 'detail address of event',
  ...
  `organizer_id` bigint(20) DEFAULT NULL COMMENT 'organizer id of this event',
...
-- ----------------------------
INSERT INTO `event_type` VALUES ('1', 'è¶³çƒ');
INSERT INTO `event_type` VALUES ('2', 'ç¯®çƒ');
INSERT INTO `event_type` VALUES ('3', 'æŽ’çƒ');
INSERT INTO `event_type` VALUES ('4', 'æ¯›çƒ');
INSERT INTO `event_type` VALUES ('5', 'ä¹’ä¹“çƒ');
INSERT INTO `event_type` VALUES ('6', 'å°çƒ');
INSERT INTO `event_type` VALUES ('7', 'ç½‘çƒ');
INSERT INTO `event_type` VALUES ('8', 'ä¿é¾„çƒ');
INSERT INTO `event_type` VALUES ('9', 'å¥èº«é¦†');
INSERT INTO `event_type` VALUES ('10', 'å®¶');
INSERT INTO `event_type` VALUES ('11', 'æ¸¸æ³³');
INSERT INTO `event_type` VALUES ('12', 'å°„å‡»');
INSERT INTO `event_type` VALUES ('13', 'è·†æ‹³é“');
INSERT INTO `event_type` VALUES ('14', 'ä¼‘é—­');
INSERT INTO `event_type` VALUES ('15', 'æ»‘å†°');
INSERT INTO `event_type` VALUES ('16', 'æ»‘é›ª');
INSERT INTO `event_type` VALUES ('17', 'æ¶ŒåŠ¨è£…å');
INSERT INTO `event_type` VALUES ('18', 'å…¶ä»–');
...
-- Records of goods
-- ----------------------------
INSERT INTO `goods` VALUES ('22', 'asdfas', '1', '0', '2018-04-26 18:39:52', '0', 'sfsdfgsdfg', '3cbb03338b147cce561e93b493c4fc2f.png', '6fe63aeaf3c0e66d739d3ac09c4f4aea.png', '1');
INSERT INTO `goods` VALUES ('23', 'asdf', '1', '43', '2018-04-26 18:10:23', '0', 'asdfasdfasdfas', 'c23648dc704ac499c1c46a9afa3ac1fe.png', 'b36952dee648364cf05b303cf0b03180.png', '1');
INSERT INTO `goods` VALUES ('24', '阿斯顿发生', '12', '0', '2018-04-28 15:16:41', '0', '阿道夫', '15248997851989.png', '15248997931017.png', '1');
INSERT INTO `goods` VALUES ('25', '变形测试', '2', '0', '2018-04-28 15:21:39', '0', '钱威威企鹅', '0', '0', '1');
INSERT INTO `goods` VALUES ('26', '', '0', '0', '2018-04-28 15:23:45', '0', '', '15249002198092.jpg', '15249002088448.jpg', '1');
INSERT INTO `goods` VALUES ('27', '士大夫', '1', '0', '2018-04-28 15:25:05', '0', '123十分士大夫', '15249002853703.jpg', '15249003007753.jpg', '1');
INSERT INTO `goods` VALUES ('28', '士大夫搜索', '12', '0', '2018-04-28 15:26:08', '0', '的说法都是', '15249003526636.jpg', '15249003659318.jpg', '1');
INSERT INTO `goods` VALUES ('29', '偶家', '2', '0', '2018-04-28 15:27:12', '0', '额', '15249004227633.jpg', '15249004301185.jpg', '1');
INSERT INTO `goods` VALUES ('30', 'asaa', '12', '0', '2018-04-30 00:46:54', '0', 'asdfasdafsdfasdf', '15250204065195.png', '15250204126098.png', '1');
INSERT INTO `goods` VALUES ('31', '和规范', '2', '70', '2018-05-04 04:08:45', '0', '苦于公开', '15253781198176.jpg', '15253781235968.jpg', '1');
INSERT INTO `goods` VALUES ('32', '哦破', '11', '0', '2018-05-04 04:09:12', '0', '；ij；急急急空间', '15253781471516.jpg', '15253781517417.jpg', '1');
INSERT INTO `goods` VALUES ('33', '试试', '11', '0', '2018-05-04 10:39:08', '0', '试试可以大什么字', '15254015216426.jpg', '15254015431504.jpg', '1');
INSERT INTO `goods` VALUES ('34', '12纳斯卡和服万我和', '100000000', '0', '2018-05-04 11:43:59', '0', '去无法全文发给我ergt\n二副你把\n而非哦亲呢无法\n违反你去问那部分\n尔股份拟哦亲额外内容\n\nerg\nergf\nerg\n汪峰\n\nerg\nwgr\nwerg\nwg\n', '15254054029492.jpg', '15254054364553.jpg', '1');
INSERT INTO `goods` VALUES ('35', '水杯', '100', '150', '2018-05-08 11:37:50', '0', '水杯的容量很大，可以装很多水', '15257506442684.jpg', '15257506666684.jpg', '1');
INSERT INTO `goods` VALUES ('36', '名称不能超过10个字', '50', '100', '2018-05-08 11:51:28', '0', '需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人需要一个人', '', '', '1');
INSERT INTO `goods` VALUES ('37', 'qwerafsd', '23', '0', '2018-05-09 06:32:03', '0', '<p><img src=\"/backend/uploads/19f2d7fefea2e0e1dab2cfc2ea62c0588a4ac79c.jpg\" style=\"width: 300px;\" class=\"fr-fic fr-dib\"></p><p>aefasd</p><p><span style=\"font-family: Impact,Charcoal,sans-serif;\">asdfasdf</span></p><p>a</p><p>asdfasdf</p>', '15258187114357.jpg', '15258187215836.jpg', '1');
INSERT INTO `goods` VALUES ('38', '在v在v是v阿道夫其', '12', '97', '2018-05-09 07:25:11', '0', '<p><img src=\"https://www.fengteam.cn/backend/uploads/cd606cc099fd6d6d5c748b94d8fea21e3417b004.jpg\" style=\"width: 300px;\" class=\"fr-fic fr-dib\"></p><p>暗示的发生大幅</p><p>阿萨德发生的发生大幅</p><p>阿萨德发生的发生的发生的发生的发生的</p><p>阿萨德发生的发生的发生大幅</p>', '15258219025870.jpg', '15258219083923.jpg', '1');
INSERT INTO `goods` VALUES ('39', '测试商品', '1', '192', '2018-05-09 15:58:15', '0', '<p><br></p><p><br></p><p><br></p><p><strong><em><u>手动阀手动阀</u></em></strong><img src=\"https://www.fengteam.cn/backend/uploads/8da86ab41e1d939302eba603a209e0accd886f06.jpg\" style=\"width: 300px;\" class=\"fr-fic fr-dib\">第三方阿三阿三</p><p><br></p>', '15258526805243.jpg', '15258526911492.jpg', '1');
INSERT INTO `goods` VALUES ('40', '士大夫收到', '12', '0', '2018-05-09 16:02:21', '0', '<p><strong><em>阿斯蒂芬</em></strong></p><p><strong><img src=\"https://www.fengteam.cn/backend/uploads/b4cc2a7de5cc3af22a2b9c0e89da1ae4961e1815.png\" style=\"width: 173px;\" class=\"fr-fic fr-dib\"></strong></p><p>第三方</p><p><strong><img src=\"https://www.fengteam.cn/backend/uploads/f39c32b0da23a441c409781d019837407ffc17f5.jpg\" style=\"width: 300px;\" class=\"fr-fic fr-dib\"></strong><br></p>', '15258529251055.jpg', '15258529372566.jpg', '1');
INSERT INTO `goods` VALUES ('41', '测试一个商品', '1', '97', '2018-05-11 16:15:59', '0', '<p><em><u><s> &nbsp;<span style=\"color: rgb(85, 57, 130);\">&nbsp; &nbsp;<strong>&nbsp; </strong><strong>&nbsp; &nbsp;&nbsp;</strong></span></s></u></em><span style=\"font-family: Georgia, serif; font-size: 30px; color: rgb(85, 57, 130);\"><strong><em><u><s>测试一下</s></u></em></strong></span></p><p><br></p><p><img src=\"https://www.fengteam.cn/backend/uploads/2f20dea1ab07f31c6c0e238b60ca517862eca66d.png\" style=\"width: 300px;\" class=\"fr-fic fr-dib\"></p>', '', '', '1');
INSERT INTO `goods` VALUES ('42', '话费', '1000', '0', '2018-05-11 10:20:26', '0', '<p><strong>话费：</strong>兑换话费，兑换之后24小时到账</p><p><img src=\"https://www.fengteam.cn/backend/uploads/2f289f554dbc130362d73f7abd6aa3fd71c17e1d.jpg\" style=\"width: 300px;\" class=\"fr-fic fr-dib\"></p>', '', '15260051585093.jpg', '1');
INSERT INTO `goods` VALUES ('43', '毛毛熊', '20000', '10', '2018-05-11 10:26:05', '0', '<p><strong>毛毛熊</strong></p><p><em>水电费&nbsp;</em></p><p><u>色粉 &nbsp;水电费&nbsp;</u></p><ol><li>违反&nbsp;</li><li>玩儿&nbsp;</li></ol><p data-empty=\"true\"><img src=\"https://www.fengteam.cn/backend/uploads/7842ad8f7c3d2e72eedc433d036f2862119a5828.jpg\" style=\"width: 300px;\" class=\"fr-fic fr-dib\"></p>', '15260055478496.jpg', '15260055622572.jpg', '1');
INSERT INTO `goods` VALUES ('44', '测试商品66', '10000', '0', '2018-05-11 18:31:13', '0', '<p>大幅</p>', '15260343414658.jpg', '15260343943788.jpg', '1');
INSERT INTO `goods` VALUES ('45', 'cbff ', '1000000000', '0', '2018-05-13 10:49:41', '1', '<p><strong>sdf</strong></p><p><strong><em>dfg df &nbsp;</em></strong></p>', '15261797687228.jpg', '15261797789543.jpg', '0');
INSERT INTO `goods` VALUES ('46', '商品商品', '100', '99', '2018-05-13 15:09:18', '1', '<p><span style=\"font-family: Impact, Charcoal, sans-serif; font-size: 24px;\"><em>商品查看</em></span></p><p><span style=\"font-family: Impact, Charcoal, sans-serif; font-size: 24px;\"><em><img src=\"https://www.fengteam.cn/backend/uploads/fd3d1b2889baa0d9293bb86493fea0087598f415.png\" style=\"width: 300px;\" class=\"fr-fic fr-dib\"></em></span><br></p>', '15261953421339.png', '15261953546502.png', '0');
...
-- Records of role
-- ----------------------------
INSERT INTO `role` VALUES ('1', 'admin', '{\"p_10\":\"1\",\"p_20\":\"1\",\"p_30\":\"1\",\"p_40\":\"1\",\"p_50\":\"1\",\"p_60\":\"1\",\"p_70\":\"1\",\"p_80\":\"1\",\"p_90\":\"1\",\"p_100\":0,\"p_110\":\"1\",\"p_120\":\"1\"}');
INSERT INTO `role` VALUES ('4', 'asdf', '{\"p_10\":1,\"p_20\":1,\"p_30\":1,\"p_40\":1,\"p_50\":0,\"p_60\":0,\"p_70\":0,\"p_80\":\"0\",\"p_90\":\"0\",\"p_100\":1,\"p_110\":1,\"p_120\":1}');
...
INSERT INTO `rule` VALUES ('2', '200');
INSERT INTO `rule` VALUES ('3', '100');
INSERT INTO `rule` VALUES ('4', '0.5');
INSERT INTO `rule` VALUES ('5', '3');
INSERT INTO `rule` VALUES ('6', '1000');
INSERT INTO `rule` VALUES ('7', '2000');
INSERT INTO `rule` VALUES ('8', '0.05');
INSERT INTO `rule` VALUES ('9', '200');
...
CREATE TABLE `user` (
  ...
  `nickname` varchar(20) DEFAULT NULL COMMENT 'nickname of user in wechat',
  `name` varchar(20) DEFAULT NULL COMMENT 'real name of user',
  `phone` varchar(15) DEFAULT NULL COMMENT 'phone number of user',
