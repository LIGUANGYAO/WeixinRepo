...
class booking_model extends CI_Model
{
    ...
    {
        $this->db->select("user.avatar,user.nickname,user.phone, booking.reg_num, booking.pay_type,booking.id");
    ...
    */
    ...
    {
        $this->db->select("booking.id, booking.state, booking.reg_num");
        $this->db->select("event.name, event.type, event.cost, event.address, event.pic, event.start_time, event.end_time");
        $this->db->from("booking");
